...
router.delete('/categories/:id', authenticateToken, async (req: AuthRequest, res) => {
  try {
    ...
    // Soft delete: Mark category and its items as deleted instead of hard delete
    // This preserves historical data in completed sessions
    await prisma.$transaction([
      ...
      // Mark all menu items in this category as deleted
